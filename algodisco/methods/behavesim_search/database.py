        ...
        if islands is not None:
            ...
            self.islands: List[AlgoIsland] = [
                AlgoIsland(
                    ...
                    cluster_sampling_temperature_init=algo_database_config.cluster_sampling_temperature_init,
                    cluster_sampling_temperature_period=algo_database_config.cluster_sampling_temperature_period,
                )
        ...
        with self._lock:
            ...
            new_islands = [
                AlgoIsland(
                    ...
                    cluster_sampling_temperature_init=self.algo_database_config.cluster_sampling_temperature_init,
                    cluster_sampling_temperature_period=self.algo_database_config.cluster_sampling_temperature_period,
                )
